...
export const styleMapping = {
  ...
  "control-panel":
    "flex items-center justify-between mb-6 p-3 bg-gray-50 rounded-lg border border-gray-200",
  "control-panel-left": "flex items-center gap-3",
  "control-panel-right": "flex items-center gap-3",

  // Button styles
  "btn-primary":
    "bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-lg font-semibold text-lg border-none shadow-md transition-all duration-200 cursor-pointer px-4 py-2 hover:transform hover:-translate-y-0.5 hover:shadow-lg",
  "btn-secondary":
    "bg-gray-100 text-gray-700 rounded-lg font-medium text-lg border-none shadow-sm transition-all duration-200 cursor-pointer px-4 py-2",
  "btn-danger":
    "bg-gradient-to-r from-error-500 to-error-600 text-white rounded-lg font-semibold text-lg border-none shadow-md transition-all duration-200 cursor-pointer px-4 py-2 hover:transform hover:-translate-y-0.5 hover:shadow-lg",
  "btn-success":
    "bg-gradient-to-r from-success-500 to-success-600 text-white rounded-lg font-semibold text-lg border-none shadow-md transition-all duration-200 cursor-pointer px-4 py-2 hover:transform hover:-translate-y-0.5 hover:shadow-lg",
  "btn-standard": "px-4 py-2 text-base font-medium",
  "btn-large": "px-6 py-3 text-lg font-semibold",

  // Card styles
  "word-card":
    "rounded-xl border-2 border-gray-200 bg-white transition-all duration-300 h-full flex flex-col cursor-pointer p-6 relative min-h-[280px] hover:transform hover:-translate-y-1 hover:shadow-wordcard-hover",
  "word-card.mastered":
    "border-success-500 bg-gradient-to-br from-success-50 to-blue-50",
  "unit-card":
    "rounded-xl border-2 border-gray-200 bg-white shadow-wordcard transition-all duration-300 h-full flex flex-col cursor-pointer relative overflow-hidden hover:transform hover:-translate-y-1 hover:shadow-wordcard-hover min-h-[320px]",
  ...
  // Stats card styles
  "stats-card":
    "rounded-xl border-2 border-gray-200 bg-white shadow-wordcard transition-all duration-300 h-full flex flex-col cursor-pointer p-5 relative hover:transform hover:-translate-y-1 hover:shadow-wordcard-hover",
  "stats-card.mastered":
    "border-success-500 bg-gradient-to-br from-success-50 to-blue-50",
  ...
  "word-card-edit":
    "absolute top-4 right-4 p-2 text-gray-500 hover:text-gray-700 transition-colors duration-200",
  ...
  "word-card-pronunciation":
    "p-1 text-gray-500 hover:text-gray-700 transition-colors duration-200",
  "word-card-meaning": "flex-1",
  "word-card-meaning-text": "text-lg text-gray-700 leading-relaxed",

  "unit-card-header":
    "bg-gradient-to-r from-blue-500 to-purple-600 p-4 rounded-t-xl",
  "unit-card-icon":
    "w-8 h-8 bg-white bg-opacity-20 rounded-lg flex items-center justify-center",
  "unit-card-actions": "flex items-center gap-2",
  "unit-card-edit":
    "p-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-colors duration-200",
  ...
  "unit-card-detail-link":
    "mt-auto flex items-center justify-between text-blue-600 hover:text-blue-700 font-medium transition-colors duration-200",

  "review-card-inner":
    "relative w-full h-full transition-transform duration-500 transform-style-preserve-3d",
  "review-card-front":
    "absolute inset-0 backface-hidden bg-white rounded-xl border-2 border-gray-200 p-8 flex flex-col items-center justify-center",
  "review-card-back":
    "absolute inset-0 backface-hidden rotate-y-180 bg-white rounded-xl border-2 border-gray-200 p-8 flex flex-col items-center justify-center",
  ...
  "spelling-input-display":
    "inline-block w-8 h-8 mx-1 text-center leading-8 border-2 rounded font-mono text-lg font-bold",
  "spelling-history": "mt-8 text-center",
  "spelling-history-item":
    "inline-block mx-1 px-3 py-1 rounded text-sm font-mono",
